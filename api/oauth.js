export default function handler(req, res) {
  ...
  // const cookie = `csrfState=${csrfState}; Max-Age=60; Path=/; HttpOnly${
  //   process.env.NODE_ENV === 'production' ? '; Secure; SameSite=Lax; Domain=yourdomain.vercel.app' : ''
  // }`;
  ...
  res.setHeader(
    'Set-Cookie',
    'sessionId=abc123; Path=/; HttpOnly; Secure; Max-Age=3600; SameSite=Lax'
  );
